...
export default function AdminDashboard() {
  ...
  const copyRequestToForm = (request) => {
    setFormData({
      ...
      issuedDate: "", // optionally leave blank
      signatory: "",  // optionally leave blank
    });
    setActivePage("create"); // automatically switch to Create page
  };

  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-indigo-100 via-white to-indigo-200">
      {/* Sidebar */}
      <div
        className={`fixed md:static inset-y-0 left-0 z-40 w-64 transform bg-white/90 backdrop-blur-lg shadow-xl flex flex-col justify-between transition-transform duration-300 
      ...
      {/* Mobile top bar */}
      <div className="md:hidden flex items-center justify-between px-4 py-3 bg-white/90 shadow">
