...
export default function CreateCertificatePage({ formData, setFormData }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-lg">
      {/* Form Card */}
      <div className="bg-gray-900/70 backdrop-blur-lg p-6 rounded-xl shadow border border-indigo-500">
        ...
        <form className="space-y-4">
          <input
            ...
            placeholder="Recipient Name (Maxlength:50)"
            maxLength={50}
            className="w-full px-4 py-2 border border-indigo-400 bg-gray-800 text-white rounded-lg focus:ring-2 focus:ring-indigo-400"
          />
          <input
            type="text"
            name="usn"
      ...
      {/* Certificate Preview */}
      <div
        className="bg-white shadow-md rounded-xl p-6 border border-indigo-200 w-full flex flex-col justify-between h-[20vh] md:h-[90%] overflow-auto"
        style={{ fontFamily: "Times New Roman, Times, serif" }}
      >
        <div className="w-11/12 mx-auto flex flex-col justify-between h-full">
          <div className="flex justify-between items-center mb-6">
