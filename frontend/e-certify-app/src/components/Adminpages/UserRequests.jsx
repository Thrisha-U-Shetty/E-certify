...
//   return (
//     <div className="p-6 bg-white border border-indigo-200 rounded-xl shadow-md">
//       <h2 className="text-xl font-bold text-indigo-800 mb-6">User Requests</h2>
//       <div className="space-y-4">
//         {requests.map((req) => (
//           <div
//             key={req.id}
//             className="p-4 border border-indigo-100 rounded-lg bg-white shadow hover:shadow-lg transition"
//           >
//             <div className="flex justify-between items-center">
//               <div>
          ...
          >
            ...
            {expanded === req.id && (
              <div className="mt-4 text-sm text-gray-200 space-y-1">
                <p><span className="font-medium text-white">Course / Event Name:</span> {req.courseTitle}</p>
                <p><span className="font-medium text-white">Certification Type:</span> {req.type}</p>
                <p><span className="font-medium text-white">USN:</span> {req.usn}</p>
                <p><span className="font-medium text-white">Start Date:</span> {req.start}</p>
                <p><span className="font-medium text-white">End Date:</span> {req.end}</p>
              </div>
            )}
          </div>
        ))}
