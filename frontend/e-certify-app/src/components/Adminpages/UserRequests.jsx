...
export default function UserRequests({ copyRequestToForm, setShowConfirm, setDeleteId }) {
          ...
          {requests.map((req) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs sm:text-sm text-gray-300">ID: {req._id}</p>
              ...
              <div className="flex gap-2 sm:gap-3 items-center">
                ...
                <button
                  ...
                  title="Copy Details"
                >
                  <ClipboardIcon className="h-5 w-5 sm:h-5 sm:w-5" />
                </button>
