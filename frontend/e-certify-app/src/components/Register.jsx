...
export default function Register() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex flex-col">
      ...
      {/* Navbar */}
      <nav className="flex justify-between items-center px-8 py-4 shadow-lg bg-black/70 backdrop-blur-lg sticky top-0 z-50">
        <h1 className="text-2xl font-extrabold text-green-400">E-Certify</h1>
        <div className="flex gap-6">
          <a href="/login" className="text-gray-300 hover:text-green-400 transition">Login</a>
          <a href="/register" className="text-gray-300 hover:text-green-400 transition">Register</a>
          <a href="/logout" className="text-gray-300 hover:text-green-400 transition">Logout</a>
        </div>
      </nav>

      {/* Register Form Section */}
      <div className="flex flex-1 items-center justify-center px-4 py-16">
        <div className="bg-gray-900/80 backdrop-blur-lg border border-green-400 shadow-2xl rounded-3xl p-10 w-full max-w-md">
          <h2 className="text-3xl font-bold text-green-400 mb-6 text-center">Create an Account</h2>
          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <input
                type="email"
                placeholder="Enter Email"
                className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 bg-black text-white"
              />
            </div>
            ...
            <div>
              <button
                type="submit"
                className="w-full py-2 px-4 bg-green-500 hover:bg-green-600 text-black font-semibold rounded-lg shadow-md transition"
              >
                Register
              </button>
            </div>
